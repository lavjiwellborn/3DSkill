...
You can also copy the production-ready scaffolds directly from [`references/scaffold-and-overlay.md`](./references/scaffold-and-overlay.md) into any project.
